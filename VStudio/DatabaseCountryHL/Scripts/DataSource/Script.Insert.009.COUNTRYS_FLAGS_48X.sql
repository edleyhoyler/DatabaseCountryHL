PRINT '|Add COUNTRYS_FLAGS_48X [  ]';
PRINT '|$(Source)$(COUNTRYS_FLAGS_48X)';
...
SET     @PATCH = ('D:\GIT\DatabaseCountryHL\VStudio\ProjectDatabaseCountryHL\DatabaseCountryHL\Flags\48x48\');
...
PRINT '|Add COUNTRYS_FLAGS_48X [OK]';
--####################
--##                ##
--##     Version    ##
--##     1.0.0.1    ##
