PRINT '|Add COUNTRYS_FLAGS_1000X [  ]';
PRINT '|$(Source)$(COUNTRYS_FLAGS_1000X)';
...
SET     @PATCH = ('D:\GIT\DatabaseCountryHL\VStudio\ProjectDatabaseCountryHL\DatabaseCountryHL\Flags\1000x\');
...
PRINT '|Add COUNTRYS_FLAGS_1000X [OK]';
--####################
--##                ##
--##     Version    ##
--##     1.0.0.1    ##
