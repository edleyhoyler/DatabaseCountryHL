PRINT '|Add COUNTRYS_FLAGS_128X [  ]';
PRINT '|$(Source)$(COUNTRYS_FLAGS_128X)';
...
SET     @PATCH = ('D:\GIT\DatabaseCountryHL\VStudio\ProjectDatabaseCountryHL\DatabaseCountryHL\Flags\128x128\');
...
PRINT '|Add COUNTRYS_FLAGS_128X [OK]';
--####################
--##                ##
--##     Version    ##
--##     1.0.0.1    ##
