PRINT '|Add COUNTRYS_FLAGS_24X [  ]';
PRINT '|$(Source)$(COUNTRYS_FLAGS_24X)';
...
SET     @PATCH = ('D:\GIT\DatabaseCountryHL\VStudio\ProjectDatabaseCountryHL\DatabaseCountryHL\Flags\24x24\');
...
PRINT '|Add COUNTRYS_FLAGS_24X [OK]';
--####################
--##                ##
--##     Version    ##
--##     1.0.0.1    ##
