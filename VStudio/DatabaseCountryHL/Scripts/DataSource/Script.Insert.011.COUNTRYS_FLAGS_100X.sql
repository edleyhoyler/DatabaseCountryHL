PRINT '|Add COUNTRYS_FLAGS_100X [  ]';
PRINT '|$(Source)$(COUNTRYS_FLAGS_100X)';
...
SET     @PATCH = ('D:\GIT\DatabaseCountryHL\VStudio\ProjectDatabaseCountryHL\DatabaseCountryHL\Flags\100x\');
...
PRINT '|Add COUNTRYS_FLAGS_100X [OK]';
--####################
--##                ##
--##     Version    ##
--##     1.0.0.1    ##
