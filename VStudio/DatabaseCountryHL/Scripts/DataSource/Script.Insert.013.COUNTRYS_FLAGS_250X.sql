PRINT '|Add COUNTRYS_FLAGS_250X [  ]';
PRINT '|$(Source)$(COUNTRYS_FLAGS_250X)';
...
SET     @PATCH = ('D:\GIT\DatabaseCountryHL\VStudio\ProjectDatabaseCountryHL\DatabaseCountryHL\Flags\250x\');
...
PRINT '|Add COUNTRYS_FLAGS_250X [OK]';
--####################
--##                ##
--##     Version    ##
--##     1.0.0.1    ##
