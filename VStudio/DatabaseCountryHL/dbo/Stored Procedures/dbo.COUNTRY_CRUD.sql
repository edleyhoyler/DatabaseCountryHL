	...
	BEGIN TRY
		...
		BEGIN
			...
			BEGIN
				...
				BEGIN
					PRINT 'UPDATE';
					UPDATE [dbo].[COUNTRY] SET [COU_NOME] = @COU_NOME, [COU_NAME] = @COU_NAME, [COU_NOMBRE] = @COU_NOMBRE, [COU_ISO31661NUMERIC] = @COU_ISO31661NUMERIC, [COU_ISO31661ALPHA2] = @COU_ISO31661ALPHA2, [COU_ISO31661ALPHA3] = @COU_ISO31661ALPHA3 WHERE [COU_ID] = @COU_ID;
				...
				BEGIN
					...
					END
					IF (@COU_NOME IS NOT NULL)
					BEGIN
						DELETE [dbo].[COUNTRY] WHERE [COU_NOME] = @COU_NOME;
					END
					IF (@COU_NAME IS NOT NULL)
					BEGIN
						DELETE [dbo].[COUNTRY] WHERE [COU_NAME] = @COU_NAME;
					END
					IF (@COU_NOMBRE IS NOT NULL)
					BEGIN
						DELETE [dbo].[COUNTRY] WHERE [COU_NOMBRE] = @COU_NOMBRE;
					END
					IF (@COU_ISO31661NUMERIC IS NOT NULL)
					BEGIN
						DELETE [dbo].[COUNTRY] WHERE [COU_ISO31661NUMERIC] = @COU_ISO31661NUMERIC;
					END
					IF (@COU_ISO31661ALPHA2 IS NOT NULL)
					BEGIN
						DELETE [dbo].[COUNTRY] WHERE [COU_ISO31661ALPHA2] = @COU_ISO31661ALPHA2;
					END
					IF (@COU_ISO31661ALPHA3 IS NOT NULL)
					BEGIN
						DELETE [dbo].[COUNTRY] WHERE [COU_ISO31661ALPHA3] = @COU_ISO31661ALPHA3;
					END
					ELSE
					BEGIN
						PRINT ('ERRO DELETE COD.0007');
						RAISERROR (15600,-1,-1, '[dbo].[COUNTRY_CRUD] - ERRO DELETE COD.0007') WITH LOG;
					END;
				END
				ELSE 
				BEGIN
